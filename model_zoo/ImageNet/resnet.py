...
__all__ = ['create_resnet', 'ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
...
def create_resnet(arch, pretrained=False, **kwargs):
    if arch == 'resnet18':
        ...
        model = resnet50_32x4d(pretrained=pretrained)
