...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
           'resnet152', 'resnext50_32x4d', 'resnext101_32x8d', 'create_resnet_cifar10']
...
def create_resnet_cifar10(arch, pretrained=False, device=None, **kwargs):
    if arch == 'resnet18':
        ...
        model = resnet101(pretrained=pretrained, device=device)
    elif arch == 'resnet152':
        model = resnet152(pretrained=pretrained, device=device)
    elif arch == 'resnext50_32x4d':
        model = resnet50_32x4d(pretrained=pretrained, device=device)
    elif arch == 'resnext101_32x8d':
        model = resnet101_32x8d(pretrained=pretrained, device=device)
    else :
        #raise ValueError
        raise ValueError('Not support this kind of Resnet model !!!')
    return model