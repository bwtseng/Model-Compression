...
__all__ = ['resnet20_cifar', 'resnet32_cifar', 'resnet44_cifar', 'resnet56_cifar', 'create_resnet_cifar10']
...
def create_resnet_cifar10(arch, pretrained=False, **kwargs):
    if arch == 'resnet20':
        ...
        #raise ValueError
        raise 'Not support this kind of Resnet model for cifar-10 dataset !!!'
