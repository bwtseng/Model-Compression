...
__all__ = ['GoogLeNet', 'googlenet', 'create_googlenet_cifar10']


_GoogLeNetOuputs = namedtuple('GoogLeNetOuputs', ['logits', 'aux_logits2', 'aux_logits1'])


def create_googlenet_cifar10(arch, pretrained, device=None):
    if arch == 'googlenet':
...
#                 nn.init.constant_(m.bias, 0)
    ...
    def forward(self, x):
        if self.transform_input:
            self.channel_0, self.channel_1, self.channel_1  = self.split(x)
