...
__all__ = ['DenseNet', 'densenet121', 'densenet169', 'densenet201', 'densenet161', 'create_densenet_cifar10']
...
def create_densenet_cifar10(arch, pretrained=False, device=None, **kwargs):
    if arch == 'densenet121':
        model = densenet121(pretrained=pretrained, device=device)
    elif arch == 'densenet161':
        model = densenet161(pretrained=pretrained, device=device)
    elif arch == 'densenet169':
        model = densenet169(pretrained=pretrained, device=device)
    elif arch == 'densenet201':
        model = densenet201(pretrained=pretrained, device=device)
    else :
        #raise ValueError
        raise ValueError('Not support this kind of densenet model !!!')
    return model
...
if __name__ == '__main__':
    model = create_densenet('densenet121')
    print(model)
