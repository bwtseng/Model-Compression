...
import model_zoo.alexnet as alex
...
if __name__ == '__main__':
    ...
    parser.add_argument('--compress', default='yaml_file/alexnet.schedule_agp.yaml', type=str, help='Path to compress configure file.')
    ...
    if args.cpu: 
        device = torch.device("cpu")
        net = alex.alexnet(pretrained=args.pre_trained)
        #net = alex.alexnet_bn()
        net.arch = args.arch
