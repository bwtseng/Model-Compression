...
import model_zoo.resnet_cifar as rst
import summary 
...
train_dataset = datasets.CIFAR10('/home/bwtseng/Downloads/data/cifar-10/batches-py/',
                                        transform=data_transforms['train'])
test_dataset = datasets.CIFAR10('/home/bwtseng/Downloads/data/cifar-10/batches-py/', 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--compress', default='yaml_file/resnet20_filters.schedule_agp.yaml', type=str, help='Path to compress configure file.')
    parser.add_argument('--arch', default='resnet20_cifar10', type=str, help='Name of used Architecture.')
    parser.add_argument('--name', default='resnet20_cifar10_saved', type=str, help='Save file name.')
    ...
    if args.cpu: 
        ...
        #net.module.classifier = nn.Linear(num_ftrs, 10)
