...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default='mobilenetv1_saved', type=str, help='Save file name.')
    ...
    if args.train:
        if args.pre_trained:
            ...
            '''
            net, compress_scheduler, optimizer, start_epoch = ckpt.load_checkpoint(
            net, "model_save/mobilenet_sgd_68.848.pth.tar", 
            model_device=device)      
            optimizer = None
            print(optimizer)
        ...
        net = ckpt.load_lean_checkpoint(net, "/home/bwtseng/Downloads/vww_mobilenetv1_distiller/model_save/imagenet_mobilenetv1_saved_best.pth.tar",
                           model_device=device)
